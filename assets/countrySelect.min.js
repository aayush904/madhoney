...
!function (n) {
  "function" == typeof define && define.amd ? define(["jquery"], function (i) {
    n(i, window, document);
  }) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(require("jquery"), window, document) : n(jQuery, window, document);
}(function (n, i, t, e) {
  "use strict";
  ...
  n(i).on("load", function () {
    ...
    _processCountryData: function _processCountryData() {
      this._setInstanceCountryData(), this._setPreferredCountries(), this.options.localizedCountries && this._translateCountriesByLocale(), (this.options.onlyCountries.length || this.options.localizedCountries) && this.countries.sort(this._countryNameSort);
    },
    ...
    _translateCountriesByLocale: function _translateCountriesByLocale() {
      for (var _n = 0; _n < this.countries.length; _n++) {
        var _i = this.countries[_n].iso2.toLowerCase();
        this.options.localizedCountries.hasOwnProperty(_i) && (this.countries[_n].name = this.options.localizedCountries[_i]);
      }
    },
    _countryNameSort: function _countryNameSort(n, i) {
    ...
    _appendListItems: function _appendListItems(i, t) {
      var e = "";
    ...
    _handleUpDownKey: function _handleUpDownKey(n) {
    ...
    _filterCountries: function _filterCountries(i) {
    ...
    _selectListItem: function _selectListItem(n) {
    ...
    _scrollTo: function _scrollTo(n) {
      if (n && n.offset()) {
        var i = this.countryList,
          ...
          r = o + s,
          u = o - e + i.scrollTop();
        if (o < e) i.scrollTop(u);else if (r > a) {
          var l = t - s;
          i.scrollTop(u - l);
        }
      }
    },
    _updateName: function _updateName(n) {
    ...
    var t,
      s = arguments;
    return i === e || "object" == _typeof(i) ? this.each(function () {
