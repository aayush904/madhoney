      ...
      while (1) switch (_context2.n) {
        case 0:
          ...
          fetch("/cart/add.js", {
                ...
                while (1) switch (_context.n) {
                  ...
                  case 2:
                    ...
                    document.querySelectorAll(".cart-count-bubble").forEach(function (el) {
                      ...
                      el.querySelector(".visually-hidden").textContent = cart.item_count + cart.item_count == 1 ? "Item" : "Items";
                    });
                  case 3:
                    return _context.a(2);
                }
            ...
            _this.innerText = "Failed to add item to cart.";
            console.error("Error adding item:", error);
          });
          setTimeout(function () {
            _this.innerText = "Add to Cart";
          }, 2000);
        case 1:
